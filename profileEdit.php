...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-9 personal-info">
      ...
      <form id="profileForm" class="form-horizontal" role="form" action="others/profileUpdateProcess.php" method="post" enctype="multipart/form-data">
        <input type="hidden" name="PatientID" value="<?php echo $p_ID; ?>">
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#profileForm').submit(function(e) {
      ...
      $.ajax({
        type: 'POST',
        url: 'others/profileUpdateProcess.php',
        data: formData,
        contentType: false,
        processData: false,
